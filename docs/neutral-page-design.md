...
- Explore uses sector selection, a market-breadth summary, two compact highlights, and a searchable/filterable table. The sector still determines the benchmark.
